...
import { logIn } from '@/server/api/apis';

import ErrorInfo from '../../components/pages/components/LoginInfo';
        ...
        logIn(companyName, password)
            .then((res) => {
                ...
                setTimeout(() => {
                    ...
                    navigate('/users/login'); // Redirect to the login page after logout.
            ...
            <div>
                <div className="tw-h-screen tw-w-screen tw-z-0 tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-flex-wrap tw-items-center tw-place-items-center">
                    <div className="tw-shadow-2xl tw-pt-20 tw-hidden md:tw-block">
                        <img src="./component/login.svg" alt="Example" />
                    </div>
                    <div
                        id="signup-form"
